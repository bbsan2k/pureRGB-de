...
PrintGameVersionOnTitleScreen:
	IF DEF(_RED) ; PureRGBnote: GREENBUILD: version text needs to be slightly moved to the left due to the larger length
		hlcoord 7, 8 
	ELSE
		hlcoord 6, 8
	ENDC
...
db $60,$61,$62,$63,$64,$65,$66,$67,$68,"@" ; "Version Tiles"
